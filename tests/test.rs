...
mod tests {
    ...
    fn test() -> Result<(), TestFailure> {
        let captured =
            capture_ignored_test("tests::self_hosted_run_reports_expected_failures_child")?;
        ensure(
        ...
        ensure_expectations(
            ...
            &[
                ...
                Expect::Present(
                    "STDOUT:",
                    "the captured run report includes a stdout heading",
                ),
                Expect::Present(
                    "Chars(['S', 'T', 'D', 'O', 'U', 'T'])",
                ...
                Expect::Present(
                    "STDERR:",
                    "the captured run report includes a stderr heading",
                ),
                Expect::Present(
                    "Chars(['S', 'T', 'D', 'E', 'R', 'R'])",
